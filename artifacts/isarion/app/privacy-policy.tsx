...
const CONTACT_EMAIL = "support@lumiq-ai.app";
const DEVELOPER_NAME = "Isarion";
...
• Subscription prices and billing periods are shown in the store at purchase time and may vary by region.
